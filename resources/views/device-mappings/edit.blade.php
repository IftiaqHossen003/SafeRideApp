        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('device-mappings.update', $deviceMapping) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <select name="user_id" id="user_id" 
                                ...
                                @foreach ($users as $user)
                                    <option value="{{ $user->id }}" 
                                            {{ old('user_id', $deviceMapping->user_id) == $user->id ? 'selected' : '' }}>
                            ...
                            <select name="traccar_device_id" id="traccar_device_id" 
                                ...
                                @foreach ($traccarDevices as $device)
                                    <option value="{{ $device['id'] }}" 
                                            ...
                                            {{ old('traccar_device_id', $deviceMapping->traccar_device_id) == $device['id'] ? 'selected' : '' }}>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="device_name" id="device_name" 
                                   value="{{ old('device_name', $deviceMapping->device_name) }}"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="unique_id" id="unique_id" 
                                   value="{{ old('unique_id', $deviceMapping->unique_id) }}"
                        ...
                        <div class="mb-6">
                            <label class="flex items-center">
                                <input type="checkbox" name="is_active" value="1" 
                                       {{ old('is_active', $deviceMapping->is_active) ? 'checked' : '' }}
