        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-lg p-8">
                ...
                <div class="flex items-center space-x-4">
                    <div class="flex-1 relative">
                        <input type="text" 
                               ...
                               class="w-full pl-12 pr-4 py-4 border-2 border-gray-200 rounded-xl focus:border-pink-500 focus:ring-2 focus:ring-pink-200 transition-all">
                    ...
                    <button class="bg-gradient-to-r from-pink-500 to-purple-600 text-white px-8 py-4 rounded-xl font-bold hover:from-pink-600 hover:to-purple-700 transition-all transform hover:scale-105 shadow-lg">
                        Start Ride
                    </button>
                </div>
                ...
                <div class="mt-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="flex items-center p-4 bg-gray-50 rounded-xl hover:bg-purple-50 cursor-pointer transition-all border border-gray-200 hover:border-purple-300">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500">Add location</p>
                            </div>
                        </div>
                        <div class="flex items-center p-4 bg-gray-50 rounded-xl hover:bg-purple-50 cursor-pointer transition-all border border-gray-200 hover:border-purple-300">
            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <!-- Standard Ride -->
                    <div class="bg-gradient-to-br from-pink-500 to-purple-600 rounded-2xl p-6 text-white cursor-pointer hover:shadow-2xl transform hover:scale-105 transition-all duration-300">
                    ...
                    <!-- Premium Ride -->
                    <div class="bg-white border-2 border-purple-200 rounded-2xl p-6 cursor-pointer hover:border-purple-400 hover:shadow-xl transition-all duration-300">
                        <div class="flex justify-between items-start mb-4">
                            <div>
                                <h4 class="text-lg font-bold text-gray-800 mb-1">SafeRide Plus</h4>
                                <p class="text-sm text-gray-600">Enhanced protection</p>
                            </div>
                            <span class="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-3 py-1 rounded-full text-sm font-bold">PRO</span>
                        </div>
                        <div class="relative h-32 mb-4">
                            <div class="absolute inset-0 flex items-center justify-center">
                    ...
                    <!-- Emergency Only -->
                    <div class="bg-white border-2 border-red-200 rounded-2xl p-6 cursor-pointer hover:border-red-400 hover:shadow-xl transition-all duration-300">
                        <div class="flex justify-between items-start mb-4">
                            <div>
                                <h4 class="text-lg font-bold text-gray-800 mb-1">Emergency Mode</h4>
                                <p class="text-sm text-gray-600">SOS alerts only</p>
                            </div>
                            <span class="bg-red-100 text-red-600 px-3 py-1 rounded-full text-sm font-bold">SOS</span>
                        </div>
                        <div class="relative h-32 mb-4">
                            <div class="absolute inset-0 flex items-center justify-center">
